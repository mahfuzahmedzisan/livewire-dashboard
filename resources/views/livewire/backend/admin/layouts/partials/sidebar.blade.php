<aside class="transition-all duration-300 ease-in-out z-50 max-h-screen py-2 pl-2"
    ...
    <div class="sidebar-glass-card h-full custom-scrollbar rounded-xl overflow-y-auto">
        ...
        <nav class="p-2 space-y-2">
            ...
            <livewire:components.admin.navlink type="single" icon="layout-dashboard" name="Dashboard" :route="route('dashboard')"
                active="admin-dashboard" :page_slug="$active" />

            <livewire:components.admin.navlink type="single" icon="layout-dashboard" name="Button UI" active="button-ui"
                :page_slug="$active" />


            <livewire:components.admin.navlink type="dropdown" icon="users" name="Admin Management" :page_slug="$active"
                :items="[
                    [
                        'name' => 'Admin',
                        'route' => '#',
            ...
            <livewire:components.admin.navlink type="dropdown" icon="users" name="User Management" :page_slug="$active"
                :items="[
                    [
                        'name' => 'All Users',
                        'route' => '#',
            ...
            <livewire:components.admin.navlink type="dropdown" icon="users" name="Package Management" :page_slug="$active"
                :items="[
                    [
                        'name' => 'Credit',
                        'route' => '#',
