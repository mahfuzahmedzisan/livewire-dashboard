<header class="sticky top-0 z-30 pt-2 px-2">
    <div class="glass-card rounded-xl">
        <div class="flex items-center justify-between p-4 lg:p-6">
            <div class="flex items-center gap-4">
                ...
                <div class="hidden sm:block">
                    <h1 class="text-xl lg:text-2xl font-bold  text-text-primary">Good morning,
                        Alex!</h1>
                    <p class="text-text-light-secondary  text-sm">Here's what's happening
                        today
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <button @click="toggleNotifications()"
                    ...
                    <flux:icon name="bell" class="w-5 h-5 text-text-primary " />
        ...
        <div class="px-4 lg:px-6 pb-4">
            <nav class="flex items-center gap-2 text-sm text-text-primary ">
                <a href="{{ route('dashboard') }}">{{ __('Admin Dashboard') }}</a>
                <flux:icon name="chevron-right" class="w-4 h-4" />
                <span class="text-text-primary  capitalize"> {{ $breadcrumb }}</span>
            </nav>
        </div>
    </div>
